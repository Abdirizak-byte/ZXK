...
if (form && responseDiv) {
  form.addEventListener('submit', async function (e) {
    ...
    try {
      ...
      if (data.success) {
        responseDiv.className = 'contact-response show success';
        responseDiv.textContent = "Thanks for reaching out! I'll get back to you within 24 hours.";
      ...
      responseDiv.className = 'contact-response show error';
      responseDiv.textContent = `Something went wrong: ${error.message}. Please try again or reach out directly.`;
    } finally {
